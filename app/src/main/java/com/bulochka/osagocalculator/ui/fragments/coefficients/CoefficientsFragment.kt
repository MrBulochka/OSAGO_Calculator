...
import com.bulochka.osagocalculator.ui.fragments.coefficients.bottom_sheet.BottomSheetFragment
...
class CoefficientsFragment: Fragment(R.layout.fragment_coefficients) {
    ...
    private val coefficientsViewModel: CoefficientsViewModel by activityViewModels {
    ...
    private fun setUpClickListeners() {
        ...
        dataAdapter.setOnDataClickListener { data ->
            val bundle = Bundle()
